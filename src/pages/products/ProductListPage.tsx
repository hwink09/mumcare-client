...
export function ProductListPage({ isLoggedIn = false, user, onLogoutClick }: ProductListPageProps) {
      ...
      <div className="container mx-auto px-4 py-10">
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Browse products from MomCare Store</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
            <input
              ...
              className="h-10 w-full sm:w-72 rounded-md border bg-background px-3 text-sm"
            />
